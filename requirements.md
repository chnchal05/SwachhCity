...
The system integrates with Surakshit Bharat CCTV infrastructure to automatically detect waste, classify it using dual AI models, generate geo-tagged alerts, and verify cleanup actions.
...
* Detection accuracy of at least 85%, with continuous improvement over time
...
* CCTV cameras have minimum 720p resolution
...
* Location metadata availability depends on CCTV infrastructure
